...
if __name__ == '__main__':
    ...
    #print(D)
    print(run_similarity_test("text.txt", D, cosine_similarity))
    print(run_similarity_test("text.txt", D, negative_distance))
    print(run_similarity_test("text.txt", D, negative_distance_normalized))
    ...
    for i in x:
        ...
        time = run_time("text.txt",files, cosine_similarity)
        y.append(time)
    plt.plot(x, y)
